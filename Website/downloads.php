...
<?php
    ...
    format_line('products/scalos/main/ScalosBeta_41.7_68K.lha', 'Scalos V41.7 for Amiga-OS 3.x/68K', '~4314KB', '15/03/2010', 'This is the complete V41.7 archive with the latest <b>BETA</b> release of the Scalos executable. You can find all the changes in this release on the <a href="versionhistory.php">version history page</a>. German and French language packs are included in the archive.');
    format_line('products/scalos/main/ScalosBeta_41.7_MOS.lha', 'Scalos V41.7 for MorphOS/PPC',      '~5350KB', '15/03/2010', 'This is the native PPC/MorphOS <b>BETA</b> release of Scalos. You can find all the changes in this release on the <a href="versionhistory.php">version history page</a>. German and French language packs are included in the archive.');
    format_line('products/scalos/main/ScalosBeta_41.7_OS4.lha', 'Scalos V41.7 for AmigaOS 4.0/PPC',  '~5483KB', '15/03/2010', 'This is the native AmigaOS 4.1 <b>BETA</b> release of Scalos. You can find all the changes in this release on the <a href="versionhistory.php">version history page</a>. German and French language packs are included in the archive.');
