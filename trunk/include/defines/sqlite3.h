...
#define SQLite3Free(___z) __SQLite3Free_WB(SQLITE3_LIB_SFD_BASE_NAME, ## __VA_ARGS__)
#define __SQLite3Free_WB(___base, ___z) \
	({APTR _args[] = { __VA_ARGS__ }; __SQLite3FreeTable_WB((___base), (___z), ); })
#endif /* !NO_INLINE_VARARGS */

#ifndef NO_INLINE_VARARGS
#define SQLite3Trace(___db, ___xTrace, ___parg) __SQLite3Trace_WB(SQLITE3_LIB_SFD_BASE_NAME, ___db, ___xTrace, ## __VA_ARGS__)
#define __SQLite3Trace_WB(___base, ___db, ___xTrace, ___parg) \
	({APTR _args[] = { __VA_ARGS__ }; __SQLite3FreeTable_WB((___base), (___db), (___xTrace), (___parg), ); })
#endif /* !NO_INLINE_VARARGS */
