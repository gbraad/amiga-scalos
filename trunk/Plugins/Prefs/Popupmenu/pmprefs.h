...
struct PopupMenuPrefs
{
    ...
    UBYTE pmp_Animation;	/* Animation, see below for defines +++only PMP_ANIM_NONE and PMP_ANIM_ZOOM+++     */
    ...
    BYTE  pmp_ShadowG;
    BYTE  pmp_ShadowB;
    BYTE  pmp_TransparencyR;    /* +++currently unused+++ */
    BYTE  pmp_TransparencyG;    /* +++currently unused+++ */
    BYTE  pmp_TransparencyB;    /* +++currently unused+++ */
    UBYTE pmp_TransparencyBlur; /* +++currently unused+++ */
    UBYTE pmp_AnimationSpeed;   /* +++currently unused+++ */
