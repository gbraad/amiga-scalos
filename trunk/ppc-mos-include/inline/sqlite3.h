#ifndef _PPCINLINE_SQLITE3_H
#define _PPCINLINE_SQLITE3_H
...
#define SQLite3Close(db) \
	...
	, SQLITE3_BASE_NAME, IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3BusyHandler(db, callback, userdata) \
	...
	, SQLITE3_BASE_NAME, LONG (*__fpt)(APTR userdata, LONG l), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3Trace(db, xTrace, parg) \
	...
	, SQLITE3_BASE_NAME, VOID (*__fpt)(APTR p, CONST_STRPTR z), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3ProgressHandler(db, nOps, xProgress, pArg) \
	...
	, SQLITE3_BASE_NAME, LONG (*__fpt)(APTR p), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3BindBlob(pStmt, i, zData, nData, xDel) \
	...
	, SQLITE3_BASE_NAME, VOID (*__fpt)(APTR p), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3CreateCollation(db, zName, eTextRep, pCtx, xCompare) \
	...
	, SQLITE3_BASE_NAME, LONG (*__fpt)(APTR p, LONG i, CONST_APTR p2, LONG j, CONST_APTR p3), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3CollationNeeded(db, pCollNeededArg, xCollNeeded) \
	...
	, SQLITE3_BASE_NAME, VOID (*__fpt)(APTR p, sqlite3 *dv, LONG eTextRep, CONST_STRPTR z), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3RollbackHook(db, callback, pUserData) \
	...
	, SQLITE3_BASE_NAME, VOID (*__fpt)(APTR pUserData), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define SQLite3CreateFunction(db, zFunctionName, nArg, eTextRep, userdata, xFunc, xStep, xFinal) \
	...
	, SQLITE3_BASE_NAME, VOID (*__fpt)(sqlite3_context *pCtx, LONG i, sqlite3_value **pVal), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
