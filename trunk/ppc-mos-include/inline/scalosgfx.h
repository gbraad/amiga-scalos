#ifndef _PPCINLINE_SCALOSGFX_H
#define _PPCINLINE_SCALOSGFX_H
...
#define ScalosGfxCreateEmptySAC() \
	...
	, SCALOSGFX_BASE_NAME, IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
